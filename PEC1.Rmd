...
group_means <- data.frame(
  MSS = rowMeans(signif_abundances[, colData(se)$Group == "MSS"]),
  PD = rowMeans(signif_abundances[, colData(se)$Group == "PD"])
)
...
ggplot(signif_abundances_long, aes(x = Group, y = Abundance, fill = Group)) +
  geom_boxplot() +
  facet_wrap(~ peptide_id, scales = "free") +
  theme_minimal() +
  labs(title = "Distribución de Abundancia de Fosfopéptidos Significativos por Grupo")
